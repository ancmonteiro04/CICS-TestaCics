	...
	<body>
		...
		<div id="show-reserva" class="content scaffold-show">
			...
			<ol class="property-list reserva">
				...
				<li class="fieldcontain">
					<span id="valorLocacao-label" class="property-label"><bean:message key="prompt.valorLocacao"/></span>
					<span class="property-value">
                        <fmt:formatNumber minFractionDigits="2" maxFractionDigits="2" 
                                          value="${requestScope.reserva.valorLocacao}" />
                    </span>
				</li>

				<li class="fieldcontain">
					<span id="dataLocacao-label" class="property-label"><bean:message key="prompt.dataLocacao"/></span>
					<span class="property-value">
                        <fmt:formatDate pattern="dd/MM/yyyy"
                                        value="${requestScope.reserva.dataLocacao}" />
                    </span>
				</li>

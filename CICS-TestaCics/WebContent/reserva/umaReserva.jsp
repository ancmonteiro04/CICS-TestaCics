...
<%@ taglib uri="http://struts.apache.org/tags-html"  prefix="html" %>
                ...
                <fieldset class="form">
                    ...
                    <c:set var="erroValorLocacao" value="" />
                    <html:messages id="mensagem" property="valorLocacao">
                        <c:set var="erroValorLocacao" value="error" />
                    </html:messages>

                    <div class="fieldcontain ${pageScope.erroValorLocacao}">
                        
                        <label for="valorLocacao">
                        	<bean:message key="prompt.valorLocacao" />
                        </label>
                        
                        <html:text property="valorLocacao" 
                                   styleClass="alinhamento" 
                                   size="9" maxlength="7"/>

                    </div>

                    <c:set var="erroDataLocacao" value="" />
                    <html:messages id="mensagem" property="dataLocacao">
                        <c:set var="erroDataLocacao" value="error" />
                    </html:messages>

                    <div class="fieldcontain ${pageScope.erroDataLocacao}">
                        
                        <label for="dataLocacao">
                        	<bean:message key="prompt.dataLocacao" />
                        </label>
                        
                        <html:text property="dataLocacao" size="9" maxlength="10"/>
